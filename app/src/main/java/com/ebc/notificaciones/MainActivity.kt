...
import com.ebc.notificaciones.ui.theme.NotificacionesTheme
...
fun NotificationView(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Button(
            onClick = {notificationService.showLargeNotificacion()}
        ) {
        ...
        Button(
            onClick = {notificationService.showImageNotificacion()}
        ) {
